...
import com.example.seckillgoods.entity.*;
import com.example.seckillgoods.exception.GlobalException;
import com.example.seckillgoods.mapper.TOrderMapper;
...
import com.example.seckillgoods.utils.MD5Util;
import com.example.seckillgoods.utils.UUIDUtil;
import com.example.seckillgoods.vo.GoodsVo;
import com.example.seckillgoods.vo.OrderDeatilVo;
...
public class TOrderServiceImpl extends ServiceImpl<TOrderMapper, TOrder> implements ITOrderService {
    ...
    public TOrder secKill(TUser user, GoodsVo goodsVo) {
        ...
        System.out.print("用户信息："+user);
        System.out.print("用户信息："+user.getId());
...
//        }
    ...
    @Transactional
    public TOrder createOrder(String userId, String goodsId) {

        System.out.print("创建订单：");
       // ValueOperations valueOperations = redisTemplate.opsForValue();
        //获取商品信息
        //TGoods goods = itGoodsService.getOne(new QueryWrapper<TGoods>().eq("id", goodsId));

        TGoods goods = itGoodsService.selectGoodsById(goodsId);
